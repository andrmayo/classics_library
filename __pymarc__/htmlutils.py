...
def html_diacr(char) -> Optional[str]:
    ...
    if not (
        ...
        or (unicode_val >= 256 and unicode_val <= 382) # covers diacritics in Latin Extended-A
        ...
        or (unicode_val >= 768 and unicode_val <= 901) # covers combining diacritical marks
        ...
        or (
            unicode_val == 1027 or unicode_val == 1031 or unicode_val == 1081 
            or unicode_val == 1107 or unicode_val == 1111)
